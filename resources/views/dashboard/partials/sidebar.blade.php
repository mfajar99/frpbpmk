           ...
           with font-awesome or any other icon font library -->
            ...
            @can('admin')
                <li class="nav-item menu-is-opening menu-open">
                    <a href="#"
                        class="nav-link {{ Request::is('dashboard/categories*') ? 'active' : '' }} {{ Request::is('dashboard/gallery_categories*') ? 'active' : '' }}">
                    ...
                    <ul class="nav nav-treeview" style="display: block;">
                        ...
                        <li class="nav-item">
                            <a href="/dashboard/gallery_categories"
                                class="nav-link {{ Request::is('dashboard/gallery_categories*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
            ...
            <li class="nav-item">
                <a href="/dashboard/disasters"
                    class="nav-link {{ Request::is('dashboard/disasters*') ? 'active' : '' }}">
            ...
            <li class="nav-item">
                <a href="/dashboard/profiles"
                    class="nav-link {{ Request::is('dashboard/profiles*') ? 'active' : '' }}">
