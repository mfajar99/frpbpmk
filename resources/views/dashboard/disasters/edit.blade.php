...
@section('content-wrapper')
    ...
    <section class="content">
        <div class="col-lg-8">
            <form method="post" action="/dashboard/disasters/{{ $disaster->slug }}" class="mb-5">
                @method('put')
                @csrf
                <div class="form-group">
                    <label for="waktu" class="form-label">Tanggal</label>
                    <input type="date" class="form-control" id="waktu" name="waktu" required
                        value="{{ old('waktu', isset($disaster) ? \Carbon\Carbon::parse($disaster->waktu)->format('Y-m-d') : '') }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea id="location" name="location" class="form-control @error('location') is-invalid @enderror"
                        placeholder="Masukkan nama kecamatan" rows="3" oninput="searchVillages()">{{ old('location', $disaster->location) }}</textarea>
                    @error('location')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('penyebab') is-invalid @enderror" id="penyebab"
                        name="penyebab" required value="{{ old('penyebab', $disaster->penyebab) }}">
                    @error('penyebab')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug"
                        name="slug" required value="{{ old('slug', $disaster->slug) }}">
                    @error('slug')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="meninggal_dunia" name="meninggal_dunia" required
                        value="{{ old('meninggal_dunia', $disaster->meninggal_dunia ?? 0) }}">
                    @error('meniggal_dunia')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="hilang" name="hilang" required
                        value="{{ old('hilang', $disaster->hilang ?? 0) }}">
                    @error('hilang')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="luka_luka" name="luka_luka" required
                        value="{{ old('luka_luka', $disaster->luka_luka ?? 0) }}">
                    @error('luka_luka')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="mengungsi" name="mengungsi" required
                        value="{{ old('mengungsi', $disaster->mengungsi ?? 0) }}">
                    @error('mengungsi')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="rumah_rusak_ringan" name="rumah_rusak_ringan"
                        required value="{{ old('rumah_rusak_ringan', $disaster->rumah_rusak_ringan ?? 0) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="rumah_rusak_sedang" name="rumah_rusak_sedang"
                        required value="{{ old('rumah_rusak_sedang', $disaster->rumah_rusak_sedang ?? 0) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="rumah_rusak_berat" name="rumah_rusak_berat" required
                        value="{{ old('rumah_rusak_berat', $disaster->rumah_rusak_berat ?? 0) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="rumah_terendam" name="rumah_terendam" required
                        value="{{ old('rumah_terendam', $disaster->rumah_terendam ?? 0) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="fas_pendidikan" name="fas_pendidikan" required
                        value="{{ old('fas_pendidikan', $disaster->fas_pendidikan ?? 0) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="fas_kesehatan" name="fas_kesehatan" required
                        value="{{ old('fas_kesehatan', $disaster->fas_kesehatan ?? 0) }}">
                    @error('mengungsi')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="fas_umum" name="fas_umum" required
                        value="{{ old('fas_umum', $disaster->fas_umum ?? 0) }}">
                    @error('fas_umum')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="fas_ibadah" name="fas_ibadah" required
                        value="{{ old('fas_ibadah', $disaster->fas_ibadah ?? 0) }}">
                    @error('fas_ibadah')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
