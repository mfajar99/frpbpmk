                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3 class="card-title ml-3">
                            <a href="/dashboard/disasters" class="btn btn-block btn-primary">Refersh</a>
                        </h3>
                        <div class="card-tools">
                            <form action="" class="form-inline" method="get">
                                @csrf
                                <button type="button" class="btn btn-default">Tgl Awal</button>
                                <input type="date" name="date" class="form-control">
                                {{-- <i class="fas fa-window-minimize"></i> --}}
                                <button type="button" class="btn btn-default">Tgl Akhir</button>
